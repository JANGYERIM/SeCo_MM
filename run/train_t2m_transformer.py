...
from data.t2m_dataset import Text2MotionDataset, collate_fn_multi_caption
...
if __name__ == '__main__':
    ...
    train_loader = DataLoader(train_dataset, batch_size=opt.batch_size, num_workers=4, shuffle=True, drop_last=True, collate_fn=collate_fn_multi_caption)
    val_loader = DataLoader(val_dataset, batch_size=opt.batch_size, num_workers=4, shuffle=True, drop_last=True, collate_fn=collate_fn_multi_caption)
